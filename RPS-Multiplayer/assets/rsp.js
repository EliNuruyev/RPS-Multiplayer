      ...
      if(playerNum){
          if(currentTurn === 1){
              if(currentTurn === playerNum){
                ...
                $("#player" + playerNum + " ul").append("<li>Rock</li><li>Scissors</li><li>Paper</li>")
              }else{
...
function gameLogic(p1Choice, p2Choice){
    var player1Won = function(){
        ...
        if(playerNum === 1){
            playersBranch.child("1").child("wins").set(player1Data.wins + 1);
            playersBranch.child("2").child("losses").set(player2Data.losses + 1);
        }
    }
    ...
    var player2Won = function(){
        ...
        if(playerNum === 2){
            playersBranch.child("1").child("losses").set(player1Data.losses + 1);
            playersBranch.child("2").child("wins").set(player2Data.wins + 1);
        }
    }
